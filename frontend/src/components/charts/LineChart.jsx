...
const LineChart = ({ data, title, xAxisLabel, yAxisLabel, tooltipFormat, darkMode }) => {
      ...
      data: {
        ...
        datasets: [{
          ...
          backgroundColor: darkMode 
            ? 'rgba(79, 70, 229, 0.2)' // Indigo color for dark mode
            : 'rgba(79, 70, 229, 0.1)', // Lighter indigo for light mode
          ...
          tension: 0.3,
          fill: true,
          pointBackgroundColor: darkMode ? '#4F46E5' : '#4F46E5',
