    ...
    <footer className="bg-white dark:bg-gray-800 shadow-inner py-8 mt-auto">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <h3 className="text-lg font-semibold text-gray-800 dark:text-white mb-4">RentalHub</h3>
            <p className="text-gray-600 dark:text-gray-300">
              Your one-stop solution for renting high-quality products at affordable prices.
            </p>
          </div>
          ...
          <div>
            ...
            <div className="mt-4">
              <p className="text-gray-600 dark:text-gray-300">Email: support@rentalhub.com</p>
        ...
        <div className="border-t border-gray-200 dark:border-gray-700 mt-8 pt-8 text-center">
          <p className="text-gray-600 dark:text-gray-300">
            &copy; {currentYear} RentalHub. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
